...
function map_emulationstation_joystick() {
    ...
    case "$input_name" in
        ...
        rightbottom|rightshoulder)
            key="pagedown"
            ;;
        up|right|down|left|start|select|lock|x|y|leftanalogup|leftanalogright|leftanalogdown|leftanalogleft|rightanalogup|rightanalogright|rightanalogdown|rightanalogleft)
            key="$input_name"
            ;;
        a)
            key="$input_name"
