...
rp_module_licence="MIT https://raw.githubusercontent.com/joaxn/RetroPie-Manager/retropie/ORIGINAL%20LICENCE.txt"
...
function sources_retropie-manager() {
    gitPullOrClone "$md_inst" "https://github.com/joaxn/RetroPie-Manager.git" retropie
}
